    ...
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-[#1A1A1A] text-white' : 'bg-gray-50 text-gray-900'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="relative w-full h-[500px]">
        ...
        <div className="absolute inset-0 z-20 flex items-center">
          <div className="container mx-auto px-4">
            <h1 className="text-5xl font-bold text-white mb-4">{program.title[currentLanguage]}</h1>
            ...
            <button className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-md text-lg font-semibold transition-colors">
      ...
      <div className="container mx-auto px-4 py-12 grid md:grid-cols-2 gap-8">
        <div>
          <h2 className="text-3xl font-bold mb-6">{t('auth.skills', 'Skills You Will Gain')}</h2>
        ...
        <div>
          <h2 className="text-3xl font-bold mb-4">{t('programs.aboutUs', 'About This Program')}</h2>
          <div className={`p-6 rounded-lg `}>
            <p className="text-lg">{program.description[currentLanguage]}</p>
          </div>
        </div>
      </div>
      ...
      {/* Course Cards */}
      {courses.length > 0 && (
        <div className={`w-full ${theme === 'dark' ? 'bg-[#1A1A1A]' : 'bg-white'} py-12`}>
          <div className="container mx-auto px-4">
                    ...
                    <div className="flex flex-col md:flex-row">
                      ...
                      <div className="p-6 md:w-2/3">
                        <div className="flex justify-between items-start">
                          <h3 className="text-2xl font-semibold mb-3">{course.title[currentLanguage]}</h3>
                          <button
      ...
      {instructors.length > 0 && (
        <div className="container mx-auto px-4 py-12">
          <h2 className="text-3xl font-bold mb-8">{t('programs.mentors', 'Mentors')}</h2>
