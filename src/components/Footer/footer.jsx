    ...
    <footer className={`${theme === 'dark' ? 'bg-[#1a1a1a]' : 'bg-gray-100'} ${theme === 'dark' ? 'text-white' : 'text-gray-800'} mt-auto`}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <a href="#" className="hover:underline">{t('footer.team', 'Team')}</a>
          <a href="#" className="hover:underline">{t('footer.contact', 'Contact')}</a>
        </div>

        {/* Column 2 */}
        <div>
          <h3 className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} font-semibold mb-6`}>{t('footer.explore', 'Explore')}</h3>
          <ul className="space-y-3">
            <li><a href="#" className="hover:underline font-semibold">{t('footer.browseCourses', 'Browse Courses')}</a></li>
            <li><a href="#" className="hover:underline font-semibold">{t('footer.popularCourses', 'Popular Courses')}</a></li>
            <li><a href="#" className="hover:underline font-semibold">{t('footer.subscriptionPlans', 'Subscription Plans')}</a></li>
            <li><a href="#" className="hover:underline font-semibold">{t('footer.instructors', 'Instructors')}</a></li>
            <li><a href="#" className="hover:underline font-semibold">{t('footer.learningPartners', 'Learning Partners')}</a></li>
          </ul>
        </div>

        {/* Column 3 */}
        <div>
          <h3 className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} font-semibold mb-6`}>{t('footer.business', 'Business')}</h3>
          <div className="flex flex-col space-y-4">
            <a href="#" className="underline font-semibold hover:text-red-500 transition-colors duration-300">
              {t('footer.becomeInstructor', 'Become an instructor')}
            </a>
            <button className="border border-red-500 text-red-500 px-6 py-2 rounded hover:bg-red-500 hover:text-white transition-colors duration-300">
              {t('footer.trainTeam', 'Train Your Team')}
            </button>
          </div>
        </div>
        ...
        {/* Column 4 */}
        <div>
          <h3 className={`${theme === 'dark' ? 'text-gray-400' : 'text-gray-600'} font-semibold mb-6`}>{t('footer.downloadApp', 'Download App')}</h3>
          <div className="flex flex-col space-y-4">
      ...
      {/* Bottom bar */}
      <div className={`${theme === 'dark' ? 'bg-[#000000]' : 'bg-gray-200'} ${theme === 'dark' ? 'border-[#000000]' : 'border-gray-300'} border-t py-4`}>
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between text-sm space-y-4 md:space-y-0">
          <div className="flex items-center space-x-4">
            ...
            <a href="#" className="hover:underline">{t('footer.terms', 'Terms of use')}</a>
            <a href="#" className="hover:underline">{t('footer.privacy', 'Privacy policy')}</a>
            <a href="#" className="text-[#3f8e9b] hover:underline">{t('footer.helpCenter', 'Help Center')}</a>
          </div>

          <div className="flex items-center space-x-6">
            {/* Icons */}
            <a href="#" aria-label="LinkedIn" className={`${theme === 'dark' ? 'text-white' : 'text-gray-700'} hover:text-blue-600 text-xl font-bold`}>
