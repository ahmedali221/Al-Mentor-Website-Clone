    ...
    <footer className="bg-[#1a1a1a] text-white" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <a href="#" className="hover:underline">{t('navigation.blog')}</a>
          <a href="#" className="hover:underline">{t('navigation.about')}</a>
          <a href="#" className="hover:underline">{t('navigation.press')}</a>
          <a href="#" className="hover:underline">{t('navigation.team')}</a>
          <a href="#" className="hover:underline">{t('navigation.contact')}</a>
        </div>

        {/* Column 2 */}
        <div>
          <h3 className="text-gray-400 font-semibold mb-6">{t('footer.explore')}</h3>
          <ul className="space-y-3">
            <li><a href="#" className="hover:underline font-semibold">{t('footer.browseCourses')}</a></li>
            <li><a href="#" className="hover:underline font-semibold">{t('footer.popularCourses')}</a></li>
            <li><a href="#" className="hover:underline font-semibold">{t('footer.subscriptionPlans')}</a></li>
            <li><a href="#" className="hover:underline font-semibold">{t('footer.instructors')}</a></li>
            <li><a href="#" className="hover:underline font-semibold">{t('footer.learningPartners')}</a></li>
          </ul>
        </div>

        {/* Column 3 */}
        <div>
          <h3 className="text-gray-400 font-semibold mb-6">{t('footer.business')}</h3>
          <div className="flex flex-col space-y-4">
        ...
        {/* Column 4 */}
        <div>
          <h3 className="text-gray-400 font-semibold mb-6">{t('footer.downloadApp')}</h3>
          <div className="flex flex-col space-y-4">
      ...
      <div className="bg-[#000000] border-t border-[#000000] py-4">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between text-gray-400 text-sm space-y-4 md:space-y-0">
          <div className="flex items-center space-x-4">
            ...
            <a href="#" className="text-[#3f8e9b] hover:underline">{t('footer.helpCenter')}</a>
          </div>
