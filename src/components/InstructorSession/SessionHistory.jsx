...
const SessionHistory = ({ isInstructor = false }) => {
        ...
        const fetchSessions = async () => {
            ...
            try {
                const endpoint = isInstructor
                    ? `https://al-mentor-database-production.up.railway.app/instructor-sessions/instructor/${user._id}`
                    : `https://al-mentor-database-production.up.railway.app/instructor-sessions/user/${user._id}`;
    ...
    const handleStatusChange = async (sessionId, newStatus, additionalData = {}) => {
        try {
            const response = await fetch(`https://al-mentor-database-production.up.railway.app/instructor-sessions/${sessionId}/${newStatus}`, {
                method: 'PUT',
                headers: {
