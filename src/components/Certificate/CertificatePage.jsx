  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Fetch course data
        const courseResponse = await axios.get(`https://al-mentor-database-production.up.railway.app/api/courses/${courseId}`);
        const course = courseResponse.data;
        setCertificateData(course);

        // Fetch all instructors
        const instructorsResponse = await axios.get('https://al-mentor-database-production.up.railway.app/api/instructors');
