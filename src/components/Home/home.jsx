...
const Home = () => {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      ...
      try {
        const res = await fetch('https://al-mentor-database-production.up.railway.app/courses');
  ...
  useEffect(() => {
    fetch('https://al-mentor-database-production.up.railway.app/category')
      .then(res => res.json())
  ...
  useEffect(() => {
    const fetchInstructors = async () => {
      ...
      try {
        const res = await fetch('https://al-mentor-database-production.up.railway.app/instructors');
